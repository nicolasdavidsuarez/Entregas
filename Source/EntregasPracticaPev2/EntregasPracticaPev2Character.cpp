...
//INTERACT!!!
	...
	{
		UE_LOG(LogEntregasPracticaPev2, Error, TEXT("'%s' Failed to find an Enhanced Input component! This template is built to use the Enhanced Input system. If you intend to use the legacy system, then you will need to update this C++ file."), *GetNameSafe(this));
	}
}

void AEntregasPracticaPev2Character::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AEntregasPracticaPev2Character::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AEntregasPracticaPev2Character::DoMove(float Right, float Forward)
{
...
void AEntregasPracticaPev2Character::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void AEntregasPracticaPev2Character::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void AEntregasPracticaPev2Character::DoJumpEnd()
{
